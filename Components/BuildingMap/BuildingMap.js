    ...
    return (
        <div className={s.map}>
            ...
            <div className={s.switchers}>
                <MapButton isActive={floor === 1 ? true : false} onClick={() => setFloor(1)}>1-ый этаж</MapButton>
                <MapButton isActive={floor === 2 ? true : false} onClick={() => setFloor(2)}>2-ой этаж</MapButton>
                <MapButton isActive={floor === 3 ? true : false} onClick={() => setFloor(3)}>3-ий этаж</MapButton>
            </div>
